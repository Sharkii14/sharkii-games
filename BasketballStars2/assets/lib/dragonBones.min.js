...
var __extends = this && this.__extends || function() {
    ...
    return function(e, i) {
        ...
        e.prototype = i === null ? Object.create(i) : (a.prototype = i.prototype,
        new a)
    }
}();
var dragonBones;
...
(function(t) {
    ...
    var a = function(t) {
        ...
        e.prototype.intersectsSegment = function(t, i, a, r, n, s, o) {
            ...
            var l = e.ellipseIntersectsSegment(t, i, a, r, 0, 0, this.width * .5, this.height * .5, n, s, o);
            return l
        }
        ;
        return e
    ...
    var r = function(t) {
        ...
        e.polygonIntersectsSegment = function(t, e, i, a, r, n, s, o) {
            ...
            for (var T = 0; T < l; T += 2) {
                ...
                var B = h * S - u * O;
                var P = (f * O - h * x) / B;
                if ((P >= m && P <= A || P >= A && P <= m) && (h === 0 || P >= t && P <= i || P >= i && P <= t)) {
                    var M = (f * S - u * x) / B;
                    if ((M >= p && M <= D || M >= D && M <= p) && (u === 0 || M >= e && M <= a || M >= a && M <= e)) {
                        if (s !== null) {
                            var E = P - t;
                            if (E < 0) {
                                E = -E
                            ...
                            if (_ === 0) {
                                ...
                                b = M;
                                if (o !== null) {
                                    o.x = Math.atan2(D - p, A - m) - Math.PI * .5;
                                    o.y = o.x
                                }
                            } else {
                                if (E < c) {
                                ...
                                if (E > d) {
                                    ...
                                    b = M;
                                    if (o !== null) {
                                        o.y = Math.atan2(D - p, A - m) - Math.PI * .5
                                    }
                                }
                            }
                            _++
        ...
        e.prototype.intersectsSegment = function(t, a, r, n, s, o, l) {
            ...
            var h = 0;
            if (i.rectangleIntersectsSegment(t, a, r, n, this.x, this.y, this.width, this.height, null, null, null) !== 0) {
        ...
        i.prototype.advanceTime = function(t) {
            ...
            if (this._cacheFrameIndex < 0 || this._cacheFrameIndex !== e) {
                var i = 0
                  , a = 0;
                for (i = 0,
                a = this._bones.length; i < a; ++i) {
                    this._bones[i].update(this._cacheFrameIndex)
                }
                for (i = 0,
                a = this._slots.length; i < a; ++i) {
...
(function(t) {
    var e = function(e) {
        ...
        i.prototype._updateDisplayData = function() {
            ...
            var r = this._displayIndex >= 0 && this._rawDisplayDatas !== null && this._displayIndex < this._rawDisplayDatas.length ? this._rawDisplayDatas[this._displayIndex] : null;
            ...
            if (this._displayData !== t || this._textureData !== e || this._meshData !== a) {
                ...
                if (this._displayData !== null && r !== null && this._displayData !== r && this._meshData === null) {
                ...
                if (this._childArmature !== null) {
                    ...
                    if (this._childArmature.inheritAnimation) {
                        ...
                        if (this._displayData !== null && this._displayData.type === 1) {
                            ...
                            var s = this._displayIndex >= 0 && this._rawDisplayDatas !== null && this._displayIndex < this._rawDisplayDatas.length ? this._rawDisplayDatas[this._displayIndex] : null;
                            if (s !== null && s.type === 1) {
                                n = s.actions
                            }
                        }
        ...
        i.prototype.intersectsSegment = function(t, e, a, r, n, s, o) {
            ...
            if (l > 0) {
                ...
                if (o !== null) {
                    this.globalTransformMatrix.transformPoint(Math.cos(o.x), Math.sin(o.x), i._helpPoint, true);
                    o.x = Math.atan2(i._helpPoint.y, i._helpPoint.x);
                    this.globalTransformMatrix.transformPoint(Math.cos(o.y), Math.sin(o.y), i._helpPoint, true);
        ...
        Object.defineProperty(i.prototype, "displayList", {
            ...
            set: function(e) {
                ...
                for (var r = 0, n = i; r < n.length; r++) {
                    var s = n[r];
                    if (s !== null && s !== this._rawDisplay && s !== this._meshDisplay && this._displayList.indexOf(s) < 0 && a.indexOf(s) < 0) {
                        a.push(s)
                    }
                }
...
(function(t) {
    var e = function() {
        ...
        t.prototype.advanceTime = function(t) {
            ...
            if (t < 0) {
                t = (new Date).getTime() * .001 - this.time
            }
            if (this.timeScale !== 1) {
                t *= this.timeScale
            }
        ...
        i.prototype.playConfig = function(e) {
            ...
            if (this._animationStates.length > 0) {
                ...
                for (var h = 0, u = this._animationStates.length; h < u; ++h) {
                    if (o.layer >= this._animationStates[h].layer) {} else {
                        l = true;
            ...
            for (var f = 0, _ = this._armature.getSlots(); f < _.length; f++) {
                ...
                if (p !== null && p.inheritAnimation && p.animation.hasAnimation(i) && p.animation.getState(i) === null) {
    ...
    var e = function(e) {
        ...
        a.prototype._updateTimelines = function() {
            {
                ...
                for (var o = 0, l = this._armature.getBones(); o < l.length; o++) {
                    ...
                    if (s in e) {
                        ...
                        var f = s in this._bonePoses ? this._bonePoses[s] : this._bonePoses[s] = t.BaseObject.borrowObject(i);
                        if (u !== null) {
        ...
        a.prototype._advanceFadeTime = function(e) {
            ...
            if (this._fadeTime >= this.fadeTotalTime) {
                ...
                this._fadeProgress = i ? 1 - this._fadeTime / this.fadeTotalTime : this._fadeTime / this.fadeTotalTime
            } else {
...
(function(t) {
    var e = function(e) {
        ...
        i.prototype._onCrossFrame = function(e) {
            ...
            if (this._animationState.actionEnabled) {
                var a = this._animationData.frameOffset + this._timelineArray[this._timelineData.offset + 5 + e];
                ...
                if (this._frameCount > 1) {
                    ...
                    if (this._frameIndex !== _) {
                        ...
                        if (this._timelineArray !== null) {
                            this._frameOffset = this._animationData.frameOffset + this._timelineArray[u.offset + 5 + this._frameIndex];
                            if (o) {
                                if (m < 0) {
    ...
    var n = function(e) {
        ...
        i.prototype._onArriveAtFrame = function() {
            e.prototype._onArriveAtFrame.call(this);
            if (this._timelineData !== null) {
                var t = this._animationData.frameFloatOffset + this._frameValueOffset + this._frameIndex * 2;
                    ...
                    if (this._animationState._fadeState !== 0 || this._animationState._subFadeState !== 0) {
                        ...
                        for (var r = 0; r < this._ffdCount; ++r) {
                            if (r < this._valueOffset) {
                                ...
                                i[r] += (this._frameFloatArray[this._frameFloatOffset + r - this._valueCount] - i[r]) * a
                            }
                        }
...
(function(t) {
    var e = function(e) {
        ...
        a.prototype._parseAnimation = function(e) {
            ...
            if (a.Z_ORDER in e) {
                this._animation.zOrderTimeline = this._parseTimeline(e[a.Z_ORDER], null, a.FRAME, 1, false, false, 0, this._parseZOrderFrame)
            }
            if (a.BONE in e) {
                var h = e[a.BONE];
                for (var u = 0, f = h; u < f.length; u++) {
            ...
            if (a.FFD in e) {
                ...
                for (var c = 0, d = h; c < d.length; c++) {
                    ...
                    var b = this._parseTimeline(_, null, a.FRAME, 22, false, true, 0, this._parseSlotFFDFrame);
                    if (b !== null) {
            ...
            if (a.IK in e) {
                ...
                for (var T = 0, A = h; T < A.length; T++) {
                    ...
                    var S = this._parseTimeline(_, null, a.FRAME, 30, true, false, 2, this._parseIKConstraintFrame);
                    if (S !== null) {
        ...
        a.prototype._parseBoneTimeline = function(t) {
            ...
            if (a.TRANSLATE_FRAME in t) {
                var i = this._parseTimeline(t, null, a.TRANSLATE_FRAME, 11, false, true, 2, this._parseBoneTranslateFrame);
                if (i !== null) {
                    this._animation.addBoneTimeline(e, i)
                }
            }
            if (a.ROTATE_FRAME in t) {
                var i = this._parseTimeline(t, null, a.ROTATE_FRAME, 12, false, true, 2, this._parseBoneRotateFrame);
                if (i !== null) {
                    this._animation.addBoneTimeline(e, i)
                }
            }
            if (a.SCALE_FRAME in t) {
                var i = this._parseTimeline(t, null, a.SCALE_FRAME, 13, false, true, 2, this._parseBoneScaleFrame);
                if (i !== null) {
                    this._animation.addBoneTimeline(e, i)
                }
            }
        ...
        a.prototype._parseSlotTimeline = function(t) {
            ...
            if (a.DISPLAY_FRAME in t) {
                i = this._parseTimeline(t, null, a.DISPLAY_FRAME, 20, false, false, 0, this._parseSlotDisplayFrame)
            } else {
            ...
            if (a.COLOR_FRAME in t) {
                r = this._parseTimeline(t, null, a.COLOR_FRAME, 21, true, false, 1, this._parseSlotColorFrame)
            } else {
        ...
        a.prototype._parseTransform = function(e, i, r) {
            ...
            if (a.ROTATE in e || a.SKEW in e) {
                i.rotation = t.Transform.normalizeRadian(a._getNumber(e, a.ROTATE, 0) * t.Transform.DEG_RAD);
                i.skew = t.Transform.normalizeRadian(a._getNumber(e, a.SKEW, 0) * t.Transform.DEG_RAD)
            } else if (a.SKEW_X in e || a.SKEW_Y in e) {
                i.rotation = t.Transform.normalizeRadian(a._getNumber(e, a.SKEW_Y, 0) * t.Transform.DEG_RAD);
                i.skew = t.Transform.normalizeRadian(a._getNumber(e, a.SKEW_X, 0) * t.Transform.DEG_RAD) - i.rotation
            }
        ...
        a.prototype._parseColorTransform = function(t, e) {
            e.alphaMultiplier = a._getNumber(t, a.ALPHA_MULTIPLIER, 100) * .01;
            e.redMultiplier = a._getNumber(t, a.RED_MULTIPLIER, 100) * .01;
            e.greenMultiplier = a._getNumber(t, a.GREEN_MULTIPLIER, 100) * .01;
            e.blueMultiplier = a._getNumber(t, a.BLUE_MULTIPLIER, 100) * .01;
...
(function(t) {
    var e = function(e) {
        ...
        i.prototype._parseBinaryTimeline = function(e, i, a) {
            ...
            if (n === 1) {
                ...
                for (var h = 0, u = 0, f = 0, _ = 0; h < o; ++h) {
                    if (f + _ <= h && u < n) {
                        f = this._frameArrayBuffer[this._animation.frameOffset + this._timelineArrayBuffer[r.offset + 5 + u]];
                        if (u === n - 1) {
                            _ = this._animation.frameCount - f
                        } else {
                            _ = this._frameArrayBuffer[this._animation.frameOffset + this._timelineArrayBuffer[r.offset + 5 + u + 1]] - f
                        }
                        u++
                    }
                    if (t.DragonBones.webAssembly) {
        ...
        i.prototype._parseAnimation = function(e) {
            ...
            i.name = t.ObjectDataParser._getString(e, t.ObjectDataParser.NAME, t.ObjectDataParser.DEFAULT_NAME);
            if (i.name.length === 0) {
        ...
        i.prototype._parseArray = function(e) {
            ...
            var o = i[9];
            var l = i[11];
            var h = new Int16Array(this._binary,this._binaryOffset + i[0],a / Int16Array.BYTES_PER_ELEMENT);
            var u = new Float32Array(this._binary,this._binaryOffset + i[2],r / Float32Array.BYTES_PER_ELEMENT);
            var f = new Int16Array(this._binary,this._binaryOffset + i[4],n / Int16Array.BYTES_PER_ELEMENT);
            var _ = new Float32Array(this._binary,this._binaryOffset + i[6],s / Float32Array.BYTES_PER_ELEMENT);
            var m = new Int16Array(this._binary,this._binaryOffset + i[8],o / Int16Array.BYTES_PER_ELEMENT);
        ...
        i.prototype.parseDragonBonesData = function(t, i) {
            ...
            if (a[0] !== "D".charCodeAt(0) || a[1] !== "B".charCodeAt(0) || a[2] !== "D".charCodeAt(0) || a[3] !== "T".charCodeAt(0)) {
...
(function(t) {
    var e = function() {
        ...
        e.prototype._buildChildArmature = function(t, e, i) {
            e;
            return this.buildArmature(i.path, t !== null ? t.dataName : "", "", t !== null ? t.textureAtlasName : "")
        }
        ;
        ...
        e.prototype.addTextureAtlasData = function(t, e) {
            ...
            e = e !== null ? e : t.name;
            var i = e in this._textureAtlasDataMap ? this._textureAtlasDataMap[e] : this._textureAtlasDataMap[e] = [];
            if (i.indexOf(t) < 0) {
                i.push(t)
            }
        }
            ...
            set: function(t) {
                ...
                if (this._renderTexture !== null) {
                    for (var e in this.textures) {
                        ...
                        i.renderTexture = new PIXI.Texture(this._renderTexture,i.region,i.region,new PIXI.Rectangle(0,0,i.region.width,i.region.height))
                    }
                } else {
                    for (var e in this.textures) {
                        var i = this.textures[e];
...
(function(t) {
    var e = function(e) {
        ...
        i.prototype._updateColor = function() {
            ...
            if (this._renderDisplay instanceof PIXI.Sprite) {
                var t = (Math.round(this._colorTransform.redMultiplier * 255) << 16) + (Math.round(this._colorTransform.greenMultiplier * 255) << 8) + Math.round(this._colorTransform.blueMultiplier * 255);
        ...
        i.prototype._updateTransform = function(t) {
            if (t) {
                ...
                if (this._renderDisplay === this._rawDisplay || this._renderDisplay === this._meshDisplay) {
                    var i = e.x - (this.globalTransformMatrix.a * this._pivotX + this.globalTransformMatrix.c * this._pivotY);
                    var a = e.y - (this.globalTransformMatrix.b * this._pivotX + this.globalTransformMatrix.d * this._pivotY);
